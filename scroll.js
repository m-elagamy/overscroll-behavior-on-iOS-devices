...
(function () {
  ...
  document.addEventListener(
    ...
    function (e) {
      ...
      while (
        (window.getComputedStyle(obj_x)["overflow-x"] != "auto" &&
          window.getComputedStyle(obj_x)["overflow-x"] != "scroll") ||
        obj_x.parentNode == null
      ) {
        obj_x = obj_x.parentNode;
      }
      while (
        (window.getComputedStyle(obj_y)["overflow-y"] != "auto" &&
          window.getComputedStyle(obj_y)["overflow-y"] != "auto") ||
        obj_y.parentNode == null
      ) {
